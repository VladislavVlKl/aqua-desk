...
const RECEPTION_ENABLED_BRANCHES = ['Chekhov Sport', 'Chekhov Light', 'Chekhov Moms'];
...
const APP_UPDATE = {
  id: '2026-08-24-groups-4status',
  title: 'Обновление групп',
  roles: null,
  items: [
    '💳 Оплаты в группах теперь в 4 статусах: «оплатили», «оплатили в том месяце», «без оплаты», «ушли».',
    '📊 На хабе группы — 4 счётчика: тап открывает список детей с этим фильтром.',
    '👶 В списке детей — цветные бейджи и фильтры; ушедшие теперь тоже видны.',
    '🗓 Абонемент действует ровно месяц от даты оплаты (а не 29 дней).',
    '📥 В Excel-отчёте — колонка «Статус» и ушедшие; суммы и ЗП считаются как прежде.',
  ],
};
