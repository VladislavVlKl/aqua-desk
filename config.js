...
// Клиентские цены за 1 ПТ — для расчётной выручки в CEO-аналитике.
// ⚠️ Уточнить по прайсу: пока приравнены к тарифам тренеров (нижняя оценка выручки).
const PT_PRICES = { 1: 85000, 2: 110000, 3: 135000 };
